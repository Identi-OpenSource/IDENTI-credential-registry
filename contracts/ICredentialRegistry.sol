...
interface ICredentialRegistry {
    ...
    function register(address issuer, address subject, bytes32 credentialHash, uint256 from, uint256 exp) external returns (bool);
    ...
    function isActive(address issuer, bytes32 _credentialHash) external view returns (bool);
